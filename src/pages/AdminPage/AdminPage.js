        ...
        <div className={styles.adminContainer}>
            ...
            <div className={styles.adminSidebar}>
                <ul>
                    ...
                    <li onClick={() => setSelectedMenu('qanda')}>1:1문의 답변</li>
                    <li onClick={() => setSelectedMenu('recharge')}>포인트 충전대기</li>
                    <li onClick={() => setSelectedMenu('exchange')}>포인트 환전대기</li>
                    <li onClick={() => setSelectedMenu('capproval')}>도전 인증 대기</li>
